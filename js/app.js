(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new swiper_core_Swiper(".slider-feedback", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
    ...
    const activeLink = menuLinks.find((link => link.href.endsWith(currentUrl)));
    if (activeLink) activateLink(activeLink); else activateLink(menuLinks[0]);
    ...
    const video = document.querySelector(".section-block__video");
    if (video) {
        const button = document.querySelector(".section-block__video-button");
